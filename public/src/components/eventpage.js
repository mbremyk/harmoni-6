                                ...
                                <Row>
                                    <Col lg={8}>
                                        ...
                                        <Col>
                                            <ListGroup>
                                                <ListGroup.Item><h6>
                                                    <b>Fra:</b> {this.formatTime(this.currentEvent.startTime)}</h6>
                                                </ListGroup.Item>
                                                <ListGroup.Item><h6>
                                                    <b>Til:</b> {this.formatTime(this.currentEvent.endTime)}</h6>
                                                </ListGroup.Item>
                                                ...
                                                <ListGroup.Item><h6><b>Arrangør:</b> {this.user.username}</h6>
                                                </ListGroup.Item>
                                                <ListGroup.Item><h6><b>Email:</b> {this.user.email}</h6>
                                                </ListGroup.Item>
                                            </ListGroup>
                                        </Col>
                                </Row>
